...
#   cloud_init_runcmd = [
#     # Set root password for PBS web interface (root@pam login)
#     "echo 'root:${var.pbs_root_password}' | chpasswd",
...
#     3. Add external datastores (S3, NFS, etc.)
#     4. Configure backup jobs in Proxmox VE
#   EOT
# }
